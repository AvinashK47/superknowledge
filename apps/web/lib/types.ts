...
export interface ExtractedFact {
  ...
  canonical_key: string;              // Normalized cluster key, e.g. "delhivery.revenue.fy24"
  value: string;                      // Display value e.g. "₹8,142 Cr", "6.4%"
  normalized_numeric_value?: number;  // Standardized unit value for mathematical comparison
  ...
  exact_quote: string;                // Verbatim quote from PDF
...
export interface DatasetSummary {
  ...
  verification_rate: number; // e.g., 98.5
}
